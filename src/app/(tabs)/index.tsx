    ...
    <View style={styles.userInfo}>
      ...
      : (
        ...
        <View style={styles.postFooter}>
          ...
          <Text style={styles.postInfo}>{isOwnPost ? "Your Post" :`${postUser?.name}`} • Expires in{" "} {formatTimeRemaining(post.expires_at)}</Text>
        </View>
...
export default function Index() {
  ...
  const pickImage = async () => {
    ...
    if (status !== "granted") {
        Alert.alert("Premission needed", "We need camera roll permissions to select a profile image");
        return;
    }
...
const takePhoto = async () => {
    ...
    if (status !== "granted") {
        Alert.alert("Premission needed", "We need camera permissions to take a photo.");
        return;
    }
    ...
    <Modal visible={showPreview} transparent animationType="fade">
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          {previewImage && (<Image cachePolicy={"none"} source={{uri: previewImage}} contentFit="cover" style={styles.previewImage}/>)}
          <TextInput 
